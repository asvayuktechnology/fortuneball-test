...
//                         <div className='bg-[#1a266b] relative w-full min-h-28 rounded-md flex items-center justify-center p-4 mb-4  text-sm'>
...
// export default BackupHelpCenter